...
import net.glowstone.compatible.message.codec.CompatibleBlockPlacementCodec;
import net.glowstone.compatible.message.codec.CompatibleCollectItemCodec;
import net.glowstone.compatible.message.codec.CompatibleSpawnMobCodec;
import net.glowstone.compatible.message.codec.CompatibleTitleCodec;
import net.glowstone.compatible.message.handler.CompatibleBlockPlacementHandler;
...
public class CompatiblePlayProtocol extends GlowProtocol {

    public CompatiblePlayProtocol() {
        super("PLAY_COMPATIBLE", 0x4B);
        ...
        inbound(0x1C, CompatibleBlockPlacementMessage.class, CompatibleBlockPlacementCodec.class, CompatibleBlockPlacementHandler.class); // Compatible message, codec and handler
        ...
        outbound(0x03, SpawnMobMessage.class, CompatibleSpawnMobCodec.class); // Compatible codec
        ...
        outbound(0x45, TitleMessage.class, CompatibleTitleCodec.class); // Compatible codec
        ...
        outbound(0x48, CompatibleCollectItemMessage.class, CompatibleCollectItemCodec.class); // Compatible message and codec
