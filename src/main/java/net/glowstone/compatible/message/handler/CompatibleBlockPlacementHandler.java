package net.glowstone.compatible.message.handler;
...
public final class CompatibleBlockPlacementHandler implements MessageHandler<GlowSession, CompatibleBlockPlacementMessage> {
    ...
    @Override
    public void handle(GlowSession session, CompatibleBlockPlacementMessage message) {
        ...
        session.setPreviousPlacement(new BlockPlacementMessage(message.getX(), message.getY(), message.getZ(), message.getDirection(), message.getHand(), (int) (message.getCursorX() * 15), (int) (message.getCursorY() * 15), (int) (message.getCursorZ() * 15)));
